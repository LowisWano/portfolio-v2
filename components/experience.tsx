...
const Experience = () => {
  const experiences = [
    ...
    },
    {
      ...
      description:
        "Developed API services, designed database schemas, and implemented responsive UI designs for Today's Carolinian publication.",
      technologies: ["React", "NextJS", "TypeScript", "Firebase","PostgreSQL", "Prisma"],
    },
  ];
